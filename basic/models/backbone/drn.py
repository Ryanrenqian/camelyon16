...
from basic.models.sync_batchnorm.batchnorm import SynchronizedBatchNorm2d
...
def drn_a_50(BatchNorm, pretrained=True):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet50'],model_dir="/userhome/renqian/download_models"))
    return model
...
def drn_c_26(BatchNorm, pretrained=True):
    ...
    if pretrained:
        pretrained = model_zoo.load_url(model_urls['drn-c-26'],model_dir="/userhome/renqian/download_models")
...
def drn_c_42(BatchNorm, pretrained=True):
    ...
    if pretrained:
        pretrained = model_zoo.load_url(model_urls['drn-c-42'],model_dir="/userhome/renqian/download_models")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
    return model
...
def drn_c_58(BatchNorm, pretrained=True):
    ...
    if pretrained:
        pretrained = model_zoo.load_url(model_urls['drn-c-58'],model_dir="/userhome/renqian/download_models")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
    return model
...
def drn_d_22(BatchNorm, pretrained=True):
    ...
    if pretrained:
        pretrained = model_zoo.load_url(model_urls['drn-d-22'],model_dir="/userhome/renqian/download_models")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
    return model
...
def drn_d_24(BatchNorm, pretrained=True):
    ...
    if pretrained:
        pretrained = model_zoo.load_url(model_urls['drn-d-24'],model_dir="/userhome/renqian/download_models")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
    return model
...
def drn_d_38(BatchNorm, pretrained=True):
    ...
    if pretrained:
        pretrained = model_zoo.load_url(model_urls['drn-d-38'],model_dir="/userhome/renqian/download_models")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
    return model
...
def drn_d_40(BatchNorm, pretrained=True):
    ...
    if pretrained:
        pretrained = model_zoo.load_url(model_urls['drn-d-40'],model_dir="/userhome/renqian/download_models")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
    return model
...
def drn_d_54(BatchNorm, pretrained=True):
    ...
    if pretrained:
        pretrained = model_zoo.load_url(model_urls['drn-d-54'],model_dir="/userhome/renqian/download_models")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
    return model
...
def drn_d_105(BatchNorm, pretrained=True):
    ...
    if pretrained:
        pretrained = model_zoo.load_url(model_urls['drn-d-105'],model_dir="/userhome/renqian/download_models")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
    return model
